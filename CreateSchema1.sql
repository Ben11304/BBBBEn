-- Create TRUONGHOC1 database if it doesn't exist
...
-- Create index on MATR if it doesn't exist
...
-- Create index on MAHS if it doesn't exist
...
-- Create index on (MATR, MAHS, NAMHOC) if it doesn't exist
